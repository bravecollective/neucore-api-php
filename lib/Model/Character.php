...
class Character implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['esi_tokens'] = $data['esi_tokens'] ?? null;
     ...
     *
     * @param \DateTime|null $valid_token_time Date and time when the valid token property was last changed.
     *
     * @return self
     */
