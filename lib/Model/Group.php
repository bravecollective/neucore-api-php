...
class Group implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'is_auto_managed' => 'setIsAutoManaged'
    ];
    ...
    protected static $getters = [
        ...
        'is_auto_managed' => 'getIsAutoManaged'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('is_auto_managed', $data ?? [], null);
    }
    ...
    */
    ...
    public function setName($name)
    {
        ...
        if (!is_null($name) && (!preg_match("/^[-._a-zA-Z0-9]+$/", ObjectSerializer::toString($name)))) {
    ...
    /**
     * Gets is_auto_managed
     *
     * @return bool|null
     */
    public function getIsAutoManaged()
    {
        return $this->container['is_auto_managed'];
    }

    /**
     * Sets is_auto_managed
     *
     * @param bool|null $is_auto_managed API: The value of this property is not always set.
     *
     * @return self
     */
    public function setIsAutoManaged($is_auto_managed)
    {
        if (is_null($is_auto_managed)) {
            array_push($this->openAPINullablesSetToNull, 'is_auto_managed');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('is_auto_managed', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['is_auto_managed'] = $is_auto_managed;
