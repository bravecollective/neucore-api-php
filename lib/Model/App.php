...
class App implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'eve_logins' => '\Brave\NeucoreApi\Model\EveLogin[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('eve_logins', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets eve_logins
     *
     * @return \Brave\NeucoreApi\Model\EveLogin[]|null
     */
    public function getEveLogins()
    {
        return $this->container['eve_logins'];
    }

    /**
     * Sets eve_logins
     *
     * @param \Brave\NeucoreApi\Model\EveLogin[]|null $eve_logins eve_logins
     *
     * @return self
     */
    public function setEveLogins($eve_logins)
    {

        if (is_null($eve_logins)) {
            throw new \InvalidArgumentException('non-nullable eve_logins cannot be null');
        }

        $this->container['eve_logins'] = $eve_logins;
