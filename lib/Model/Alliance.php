 ...
 */
class Alliance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Alliance';
    ...
    */
     ...
     * Sets name
     *
     * @param string $name EVE alliance name.
     *
     * @return self
     */
     ...
     * Sets ticker
     *
     * @param string $ticker Alliance ticker.
     *
     * @return self
     */
