...
class ApplicationApi
{
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function corporationPlayersV1Request($corporation_id)
    {
    ...
    protected function groupsWithFallbackV1Request($character, $corporation, $alliance = null)
    {
        ...
        // query params
        if ($character !== null) {
            if('form' === 'form' && is_array($character)) {
        ...
        // query params
        if ($corporation !== null) {
            if('form' === 'form' && is_array($corporation)) {
                foreach($corporation as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['corporation'] = $corporation;
            }
        }
        // query params
        if ($alliance !== null) {
            if('form' === 'form' && is_array($alliance)) {
                foreach($alliance as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['alliance'] = $alliance;
            }
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function incomingCharactersV1Request($character_id)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function playerCharactersV1Request($player_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function playerWithCharactersV1Request($character_id)
    {
        // verify the required parameter 'character_id' is set
        if ($character_id === null || (is_array($character_id) && count($character_id) === 0)) {
            throw new \InvalidArgumentException(
