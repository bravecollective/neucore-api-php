...
class ApplicationGroupsApi
{
     ...
     * @return int[]
     */
    public function groupMembersV1($group_id)
    {
        list($response) = $this->groupMembersV1WithHttpInfo($group_id);
        return $response;
    }
     ...
     */
    public function groupMembersV1WithHttpInfo($group_id)
    {
        $request = $this->groupMembersV1Request($group_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function groupMembersV1Async($group_id)
    {
        return $this->groupMembersV1AsyncWithHttpInfo($group_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function groupMembersV1AsyncWithHttpInfo($group_id)
    {
        $returnType = 'int[]';
        $request = $this->groupMembersV1Request($group_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function groupMembersV1Request($group_id)
    {
