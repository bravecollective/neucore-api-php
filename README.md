...
{
  "require": {
    "bravecollective/neucore-api": "^1.36"
  }
}
```
...
*ApplicationESIApi* | [**esiEveLoginTokenDataV1**](docs/Api/ApplicationESIApi.md#esievelogintokendatav1) | **GET** /app/v1/esi/eve-login/{name}/token-data | Returns data of valid tokens for an EVE login.
