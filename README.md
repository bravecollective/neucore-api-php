...
{
  "require": {
    "bravecollective/neucore-api": "^1.33"
  }
}
```
...
*ApplicationESIApi* | [**esiEveLoginCharactersV1**](docs/Api/ApplicationESIApi.md#esievelogincharactersv1) | **GET** /app/v1/esi/eve-login/{name}/characters | Returns character IDs of characters that have a valid ESI token of the specified EVE login.
