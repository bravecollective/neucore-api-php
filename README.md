...
```
{
  "repositories": [
    {
      "type": "git",
      "url": "https://github.com/brave/neucore-api.git"
    }
  ],
  "require": {
...
------------ | ------------- | ------------- | -------------
*ApplicationApi* | [**corpGroupsBulkV1**](docs/Api/ApplicationApi.md#corpgroupsbulkv1) | **POST** /app/v1/corp-groups | Return groups for multiple corporations.
*ApplicationApi* | [**corpGroupsV1**](docs/Api/ApplicationApi.md#corpgroupsv1) | **GET** /app/v1/corp-groups/{cid} | Return groups for the corporation.
