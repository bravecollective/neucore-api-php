...
{
  "require": {
    "bravecollective/neucore-api": "^2.2"
  }
}
```
...
*ApplicationCharactersApi* | [**playersV1**](docs/Api/ApplicationCharactersApi.md#playersv1) | **POST** /app/v1/players | Returns player accounts identified by character IDs.
